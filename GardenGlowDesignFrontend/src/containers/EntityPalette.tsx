...
export const EntityPalette: React.FC<EntityPaletteProps> = (props) => {
    ...
    return (
        ...
        >
            <Box>
                <Button fullWidth onClick={() => setIsShapesOpen(!isShapesOpen)}
            ...
            <Box>
                <Button fullWidth onClick={() => setIsEffectsOpen(!isEffectsOpen)}
                        sx={{color: '#fff', justifyContent: 'flex-start'}}>
            ...
            <Divider sx={{bgcolor: '#444'}}/>
            <Box>
                <Button fullWidth onClick={() => setIsColorsOpen(!isColorsOpen)}
                        sx={{color: '#fff', justifyContent: 'flex-start'}}>
